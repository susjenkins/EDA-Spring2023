...
```{r Plots2018, echo=FALSE, fig.cap= "Mean Ozone Concentration by Month in 2018", fig.align='left', fig.height=2.5}
...
Ozone.2018 <- epa_data %>% 
  ...
  geom_boxplot() +
  labs(title = "Mean Ozone Concentration by Month in 2018",
    x = "Month", y = "Mean Ozone Level") 

print(Ozone.2018)

```

```{r Plots2019, echo=FALSE, fig.cap= "Mean Ozone Concentration by Month in 2019", fig.align='left', fig.height=2.5}
...
Ozone.2019 <- epa_data %>% 
  ...
  ggplot(
    aes(x=factor(Month), y=Ozone)) +
  geom_boxplot() +
  labs(title = "Mean Ozone Concentration by Month in 2019",
    x = "Month", y = "Mean Ozone Level") 
...
https://github.com/susjenkins/EDA-Spring2023.git
