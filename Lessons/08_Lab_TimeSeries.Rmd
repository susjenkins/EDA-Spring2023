...
#separate is like the text to column function in excel
...
#frequency depends on monthly data = 12 or weekly = 7 or daily = 365
...
#s.window is seasonal window = periodic then it refers to however you set your frequency; must have set frequency for this to work
...
#looking for a trend in inc/dec for each season of the year; look at each season separately -- note: if you use the one in the videos you don't get this (?) 

#looking at Temp_trend == p values less than .05 so we reject the null hypotesis === positive s is statistically significant
#pos s means we have increasing trend; test was able to statistically prove what we see in the plots
